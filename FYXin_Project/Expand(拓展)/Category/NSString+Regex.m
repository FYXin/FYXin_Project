...
- (BOOL)f_isValidMobileNum {
    ...
    BOOL ret = [self f_isValidateByRegex:mobileNoRegex];
    BOOL ret1 = [self f_isValidateByRegex:phsRegex];
...
- (BOOL)f_isValidMobileNumClassification {
    ...
    if (([self f_isValidateByRegex:CM]) ||
        ([self f_isValidateByRegex:CU]) ||
        ([self f_isValidateByRegex:CT]) ||
        ([self f_isValidateByRegex:PHS]))
    {
        return YES;
    } else  {
        return NO;
...
- (BOOL)f_isValidEmailAddress {
    ...
    return [self f_isValidateByRegex:emailRegex];
}
...
- (BOOL)f_isValidPostalcode {
    ...
    return [self f_isValidateByRegex:postalRegex];
}
...
- (BOOL)f_isValidCarNum {
    ...
    return [self f_isValidateByRegex:carRegex];
}
...
- (BOOL)f_isValidChinese {
    ...
    return [self f_isValidateByRegex:chineseRegex];
}
...
- (BOOL)f_isValidMacAddress {
    ...
    return  [self f_isValidateByRegex:macAddRegex];
}
...
- (BOOL)f_isValidUrlAddress {
    ...
    return [self f_isValidateByRegex:regex];
}
...
- (BOOL)f_isValidIPAddress {
    ...
    BOOL rc = [self f_isValidateByRegex:regex];
...
- (BOOL)f_isSimpleVerifyIdentityCardNum {
    ...
    return [self f_isValidateByRegex:regex2];
}
...
- (BOOL)f_isValidTaxNum {
    ...
    return [self f_isValidateByRegex:taxNoRegex];
}
 ...
 *  @return 返回是否匹配结果
 */
- (BOOL)f_isValidateByRegex:(NSString *)regex {
